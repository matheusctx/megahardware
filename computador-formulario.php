...
<?php }?>
 ...
 <div class="container"><br>
	<div class="card border-Light">
	  ...
	  <div class="card-body">
	  <form id="computador-form" action="computador-inserir.php" method="post">
			<div class="row">
				<div class="col">
			...
			<div class="row">
				<div class="col">
					...
					<input type="text" name="campo_memoria" class="form-control">
				</br>
				</div>	
				<div class="col">	
					<label for="Processador"><h6>Processador</h6></label>
					<input type="text" name="campo_processador" class="form-control">
				</br>
				</div>
			</div>	
			<div class="row">
				<div class="col">
					...
					<input type="text" name="campo_armazenamento"  class="form-control">
				</br>
				</div>	
				<div class="col">	
					<label for="Tela"><h6>Tela</h6></label>
					<input type="text" name="campo_tela"  class="form-control">
				</br>
				</div>
			</div>	
			<div class="form-group">	
				<label for="Sistema"><h6>Sistema</h6></label>
                <input type="text" name="campo_sistema"  class="form-control">
				</br>
